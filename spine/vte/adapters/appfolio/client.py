...
logger = logging.getLogger("vte.adapter.appfolio")

class AppFolioClient:
    """
    Playwright-based client for AppFolio.
    Handles Cookie persistence, Page Navigation, and Writeback.
    """
    def __init__(self, headless: bool = True, slow_mo: int = 0):
        ...
        self.cookie_path = os.getenv("APPFOLIO_COOKIE_PATH", "/app/storage/cookies/appfolio.json")
